...
export function CompanyNumberBanner(props: CompanyNumberBannerProps) {
  return (
    <section className="!px-4">
      <div className="relative rounded-2xl xl:rounded-[25px] bg-no-repeat bg-[url('src/assets/company-banner.webp')] xl:max-w-[96%] 1400:max-w-[90%] 1500:max-w-[84%] 3xl:!max-w-[1560px] max-w-[800px] mx-auto bg-center bg-cover py-[22px] !px-4 3xl:px-[30px] flex !gap-3 3xl:!gap-4 500:flex-row flex-col overflow-hidden xl:bg-full items-center justify-center">
